            ...
            @if (auth()->user()->role_id == 1)
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'complaints' ? ' active bg-gradient-primary' : '' }} "
                        ...
                        <span class="nav-link-text ms-1">Жалобы</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'arbitraj' ? ' active bg-gradient-primary' : '' }} "
                        href="{{ route('arbitraj') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">report</i>
                        </div>
                        <span class="nav-link-text ms-1">Запрос на Арбитраж</span>
                    </a>
                </li>
            @endif
