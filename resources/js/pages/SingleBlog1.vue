                                ...
                                <div class="article-img">
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item" v-for="(image, index) in post.images"
                            ...
                            <div class="widget widget-author">
                                ...
                                <div class="widget-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h6 v-if="post.user"> {{ post.user }} </h6>
                                        </div>
                                    </div>
                            ...
                            <div class="widget widget-latest-post">
                                ...
                                <div class="widget-body">
                                    <div v-for="(relatedPost, index) in relatedPosts" :key="index"
                                        ...
                                        <div class="lpa-right">
                                            <img v-if="relatedPost.images.length > 0" :src="relatedPost.images[0].url"
