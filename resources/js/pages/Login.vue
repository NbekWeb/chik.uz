                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="p-4 text-black card-body p-lg-5">
                                    <div class="pb-1 mb-3 d-flex align-items-center">
                                        ...
                                        <span class="mb-0 h1 fw-bold">Chik</span>
                                    </div>
                                    <h5 class="pb-3 mb-3 fw-normal" style="letter-spacing: 1px;">Войти</h5>
                                    <form @submit.prevent="submit">
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Все ещё нету аккуанта? <a
                                                href="#!" style="color: #393f81;"><router-link
                                                    :to="{ name: 'Register' }">Регистрация</router-link></a></p>
