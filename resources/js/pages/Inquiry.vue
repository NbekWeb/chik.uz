<template>
    ...
    <div class="container">
        <div class="flex gap-4">
            ...
            <div class="flex-grow max-lg:w-full">
                <main class="content">
                        ...
                        <div class="bg-white rounded-md">
                            <div class="row g-0">
                                <div class="col-12">
                                    ...
                                    <div
                                        class="flex-grow-0 px-4 py-3 border-top"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                />
                                                <div
                                                    class="max-w-[140px] max-md:ml-2 md:ml-4 canSend"
                                                >
                                                    <a-spin
                                                        :spinning="!canSend"
                                                    >
            ...
            <div class="lg:block max-lg:hidden">
                <div class="text-xl font-semibold bg-white rounded-2xl">
                    ...
                    <p class="px-4 py-3 mb-0 border-t">
                        Время:<span class="ml-1 text-muted">{{ inquiry.created_at }}</span>
                    </p>
                    <p class="px-4 py-3 border-t">
                        Цена:<span class="ml-1 text-muted">
                            {{ formatPrice(parseInt(inquiry.price)) }}</span
                        >
                    </p>
                </div>
