                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <div class="row ms-auto">
                        <div class="col-12 ps-0">
                            <ul class="navbar-nav float-none float-md-end d-flex justify-content-md-around">
                                <li class="nav-item dropdown">
                                    <!--<a class="nav-link active" href="#">Home</a>-->
                                    <a class="nav-link dropdown-toggle" @click="$router.push('/design')" role="button"
                                        aria-expanded="false">
                                        Дизайн
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" @click="$router.push('/development')"
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" @click="$router.push('/texts')" role="button"
                                        aria-expanded="false">
                                        Тексты и Переводы
                                    </a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" @click="$router.push('/seo')" role="button"
                                        aria-expanded="false">
                                        SEO и трафик
                                    </a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" @click="$router.push('/social')" role="button"
                                        aria-expanded="false">
                                        Соцсети и реклама
                                    </a>
                                    <ul class="dropdown-menu">
