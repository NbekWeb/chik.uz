...
const paginationHandle=(page)=>{
    filterByCategory(route.query.category,page)
    console.log(page)
}
...
<template>
    <div class="container pt-3 post-component">
        <div class="">
            ...
            <a-spin :spinning="loading">
                <div
                    class="min-h-[250px] flex flex-col justify-center md:mt-6 max-md:mt-3"
                >
...
.post-component .swiper-button-prev,
.post-component .swiper-button-next {
